				...
				if ( certificateInfo.lpszSubjectInfo )
				{
					...
					if (pos == std::string::npos)
					{
						...
						if (currString.size() >= 11 &&
							(currString.find(".watrbx.wtf") != std::string::npos || 
							currString.find(".pizzaboxer.fun") != std::string::npos))
						{
							foundIt = true;
						}
						foundIt = true;
					...
					if (currString.size() >= 11 &&
                        (currString.find(".watrbx.wtf") != std::string::npos || currString.find(".pizzaboxer.fun") != std::string::npos))
						foundIt = true;
