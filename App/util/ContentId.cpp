...
namespace RBX
{
	...
	bool ContentId::reconstructUrl(const std::string& baseUrl, const char* const paths[], const int pathCount)
	{
		...
		// remove any spaces since HTParse stops parsing at the first space and we need to handle "http://www.watrbx.wtf/asset/?id= 1818"
