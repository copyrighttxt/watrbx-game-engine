	...
	void DataStore::onServiceProvider(ServiceProvider* oldProvider, ServiceProvider* newProvider) 
	{
		...
		if (newProvider)
		{
            ...
            if (cp)
            {
                ...
                {
                    //https://api.gametest1.pizzaboxer.fun//persistence/set?placeId=124921244&key=BF2%5Fds%5Ftest&&type=standard&scope=global&target=BF2%5Fds%5Fkey%5Ftmp&valueLength=31
