...
static const TCHAR* BootstrapperMutexName   = _T("www.watrbx.wtf/bootstrapper");
static const TCHAR* StartRobloxAppMutex     = _T("www.watrbx.wtf/startRobloxApp");
static const TCHAR* LauncherFileName        = _T("RobloxProxy.dll");
static const TCHAR* LauncherFileName64      = _T("RobloxProxy64.dll");
static const TCHAR* FriendlyName            = _T("watrbx");
...
void BootstrapperClient::deployRobloxProxy(bool commitData)
{
...

	{
		...
		CreateKey(allowedDomainsKey, _T("watrbx.wtf"));
		CreateKey(allowedDomainsKey, _T("pizzaboxer.fun"));
	}
